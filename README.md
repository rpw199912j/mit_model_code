...
- [General Workflow (Work in progress)](https://github.com/rpw199912j/mit_model_code#general-workflow-work-in-progress)
  ...
  * [2. Model Building](https://github.com/rpw199912j/mit_model_code#2-model-building)
    ...
    + [2.2 Evaluate model performance and save models](https://github.com/rpw199912j/mit_model_code#22-evaluate-model-performance-and-save-models)
...
After data cleaning, the dataset now has 102 features remaining and will be referred to as the full feature set from now on.
...
The training process starts with hyperparameter tuning with grid search cross validation. The parameter search grid is as 
follows.
...
This notebook contains the code that tunes, trains and evaluates the models along with the SHAP analysis.
